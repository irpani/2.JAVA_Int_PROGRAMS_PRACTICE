...
// What is a Median?
// Median is defined as the value which is present in the middle for a series of
// values. Note, in order to find the median of an array of integers, we must
// make sure they are sorted.

// Mathematically, Intuition :
// The problem requires us to simply implement the mathematical formula
// programmatically. Hence, we need to make sure that the array is sorted and
// calculate the answer based on whether n is odd or even.
